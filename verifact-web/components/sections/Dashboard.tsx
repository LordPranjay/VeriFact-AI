  ...
  return (
    <section className="container mx-auto px-4 py-16">
      <motion.div
        ...
        transition={{ duration: 0.6 }}
      >
        <Card className="shadow-xl overflow-hidden border-0 rounded-2xl bg-gradient-to-br from-white to-emerald-50 transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
          <CardContent className="p-8 md:p-10">
            <motion.h2
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
              ...
              className="text-2xl font-bold text-gray-800 mb-8 flex items-center"
            >
              <span className="bg-emerald-100 p-2 rounded-lg mr-3 transition-all duration-300 hover:bg-emerald-200 hover:rotate-3">
            ...
            >
              {stats.map((stat: any, index: any) => (
                <motion.div
                  key={index}
                  variants={fadeIn("up", "spring", index * 0.2, 0.75)}
                  className="flex flex-col p-6 rounded-xl bg-white border border-emerald-100 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group relative overflow-hidden"
                >
                  ...
                  <div className="flex items-center mb-3">
                    <div className="p-2 bg-emerald-50 rounded-lg text-emerald-500 mr-3 group-hover:bg-emerald-100 transition-colors duration-300">
                      {stat.icon}
                    </div>
                  </div>
                  <span className="text-3xl md:text-4xl font-bold text-emerald-600 mb-2 relative">
                    {stat.value}
